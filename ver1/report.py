...
# background3, end 이미지 추가 필요
background3 = pygame.image.load("./image/3rd_background.png")
...
while RUN:
    ...
    if stage == 0:
        ...
        # 충돌 감지
        if (character_main_x_pos < 750 and character_main_x_pos > 300) and (
                character_main_y_pos < 525 and character_main_y_pos > 400):
            MENUCLEAR = 1
            stage = 1
            character_main_x_pos = (WIDTH / 2) - character_main_width
